...
- `/short-form/` : full transcripts of the 10 most-viewed Instagram reels for Kallaway (sponsored posts left out), Dylan Page, Roberto Nickson (RPN), Cleo Abram, Nick Saraev and Natalie Fratto. Data in `data/short-form/<creator>.json`, listed in `SHORT_FORM` in `build.py`.
